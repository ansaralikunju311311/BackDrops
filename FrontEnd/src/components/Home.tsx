              ...
              { num: '12', title: 'Post-Event Review & Reporting' }
                ...
                <div key={step.num} className="flex flex-col items-center w-full relative px-2">
                  <motion.div
                    ...
                    className="w-24 h-24 rounded-full border border-brand-gold/40 bg-[#16171d] flex items-center justify-center font-mono font-light text-[2.2rem] z-10 transition-all duration-300 hover:border-brand-gold hover:shadow-[0_0_25px_rgba(212,175,55,0.4)] cursor-default text-brand-gold"
                  >
                    #{step.num}
                  </motion.div>
        ...
        <div className="max-w-[140rem] mx-auto px-6 md:px-12 lg:px-24 text-center">
          ...
          <div className="max-w-[90rem] mx-auto flex flex-col items-center">
            ...
            <Link
              ...
              style={{ fontSize: '2rem' }}
            >
              Request Consultation <span className="font-light text-[2.2rem] group-hover:translate-x-1 transition-transform duration-300">+</span>
            </Link>
