  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-[#000000] ${
        isScrolled
          ? 'py-2 border-b border-brand-white/5 shadow-[0_10px_30px_rgba(0,0,0,0.8)]'
          : 'py-3'
      }`}
    >
      <div className="max-w-[140rem] mx-auto px-6 md:px-12 lg:px-24 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center group py-1">
          <BexLogo scale={isScrolled ? 0.80 : 0.90} />
        </Link>
          ...
          <AnimatePresence>
            {isScrolled && (
              ...
              >
                ...
                >
                  Get a Quote <span className="font-light text-[2.4rem] group-hover:translate-x-1 transition-transform duration-300">+</span>
                </Link>
              </motion.div>
            )}
          </AnimatePresence>
