...
import { CheckCircle2, Handshake, Zap, Shield, Settings, Globe } from 'lucide-react';
            ...
            {values.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`text-center ${isTop ? 'mb-6' : 'mt-6 order-last'}`}>
                  ...
                  {/* Hexagon Wrapper */}
                  <motion.div 
                    whileHover={{ y: isTop ? -8 : 8, scale: 1.05 }}
                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    className="relative w-[120px] h-[138px] group cursor-pointer flex items-center justify-center filter drop-shadow-[0_15px_20px_rgba(158,83,48,0.15)]"
                  >
                    {/* SVG Hexagon Polygon */}
